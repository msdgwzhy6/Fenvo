...
-(id) initWithView:(UIView *)view withBlur:(BOOL)blur andColor:(UIColor *)backColor
{
    // CHeck
...
-(void) commonInit
{
    ...
    // init Background
    [self initBackgroundWithBlur:_isShouldBlur andBackgroundColor: _backgroundColor];
    
    // init Ten Dot
    [self initDot];
    
}
-(void) initBackgroundWithBlur:(BOOL)blur andBackgroundColor: (UIColor *)color
{
