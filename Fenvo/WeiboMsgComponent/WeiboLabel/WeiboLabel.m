...
@interface WeiboLabel()<TTTAttributedLabelDelegate>
...
//    [self initPlist];
    ...
    UIColor *commonLinkColor = RGBACOLOR(250, 143, 5, 1);
...
//                                                           range:NSMakeRange(0, [emojiText length])];
    ...
    for (NSTextCheckingResult *result in emojis) {
        ...
        NSDictionary *emojiDict = self.customEmojiRegularExpression?self.customEmojiDictionary:[WeiboLabel emojiDictionary];
