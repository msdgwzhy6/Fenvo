...
@implementation WeiboGetBlurImage
+ (WeiboGetBlurImage *)shareWeiboGetBlurImage
{
    static WeiboGetBlurImage *weiboGetBlurImage;
    @synchronized(self){
        if (!weiboGetBlurImage) {
            weiboGetBlurImage = [[self alloc]init];
        }
    }
    return weiboGetBlurImage;
}
